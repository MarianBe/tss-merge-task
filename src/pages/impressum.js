...
const Imprint = () => {
  return (
    <Container>
      ...
      <p>
        Handelsregister: Amtsgericht Ulm, HRB 734304
        <br />
        Geschäftsführer: Kadir Su, Melik Su
        <br />
        USt-IdNr: DE309273813
        <br />
        Steuernummer: 50489/23819
        <br />
      </p>

      <p>
        Das vorliegende Projekt wurde von Marian Beuther, Ivan Bauer und Melik
        Su programmiert.
      </p>
